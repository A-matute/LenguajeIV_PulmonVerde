...
const routertipo_espacio = express.Router();

// Importamos la conexión a la base de datos 
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de laos espacios.
routertipo_espacio.get('/tipo_espacio', (req, res) => {
    ...
    const columnas = 'cod_tipo_espacio, nombre_tipo_espacio';

    // Definimos el nombre de la tabla.
    const tabla = 'tipo_espacio';
...
// Ruta POST para insertar un nuevo tipo_espacio.
routertipo_espacio.post('/tipo_espacio', (req, res) => {
    ...
    // Armamos los valores, con cod_tipo_espacio sin comillas (porque es número)
    const datos = `${cod_tipo_espacio}, '${nombre_tipo_espacio}'`;
...
// Definimos la ruta PUT para actualizar registro en la tabla tipo_espacio.
routertipo_espacio.put('/tipo_espacio', (req, res) => {
...
module.exports = routertipo_espacio;