...
// Importamos la conexión a la base de datos (desde models/empleados-model.js)
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de los empleados.
router.get('/empleados', (req, res) => {
    ...
    const columnas = 'cod_empleado, numero_empleado, fecha_ingreso, salario, estado_empleado, cod_usuario, cod_mantenimiento';
...
// Ruta POST para insertar un nuevo empleado.
router.post('/empleados', (req, res) => {
    // Extraer cod_empleado y los demás campos del body
    const {
        cod_empleado,
        numero_empleado,
        fecha_ingreso,
    ...
    // Armamos los valores, con cod_empleado sin comillas (porque es número)
    const datos = `${cod_empleado}, ${numero_empleado}, '${fecha_ingreso}', ${salario}, '${estado_empleado}', ${cod_usuario}, ${cod_mantenimiento}`;
...
// Definimos la ruta PUT para actualizar registro en la tabla empleados.
