...
const routertipo_evento = express.Router();

// Importamos la conexión a la base de datos 
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de los eventos.
routertipo_evento.get('/tipo_evento', (req, res) => {
    ...
    const columnas = 'cod_tipo_evento, nombre_evento';
...
// Ruta POST para insertar un nuevo tipo_evento.
routertipo_evento.post('/tipo_evento', (req, res) => {
    ...
    // Armamos los valores, con cod_tipo_evento sin comillas (porque es número)
    const datos = `${cod_tipo_evento}, '${nombre_evento}'`;
...
// Definimos la ruta PUT para actualizar registro en la tabla tipo_evento.
routertipo_evento.put('/tipo_evento', (req, res) => {
...
module.exports = routertipo_evento;