...
// Importamos la conexión a la base de datos (desde models/espacios-model.js)
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de los espacios.
router.get('/espacios', (req, res) => {
    ...
    const columnas = 'cod_espacio, nombre_espacio, Descripcion, cantidad_personas, codigo_tipo_espacio, cod_parque';
...
// Ruta POST para insertar un nuevo espacio.
router.post('/espacios', (req, res) => {
    // Extraer cod_espacio y los demás campos del body
    const {
        cod_espacio,
        nombre_espacio,
        Descripcion,
   ...
   // Armamos los valores, con cod_espacio sin comillas (porque es número)
    const datos = `${cod_espacio}, '${nombre_espacio}', '${Descripcion}', ${cantidad_personas}, ${codigo_tipo_espacio}, ${cod_parque}`;
...
// Definimos la ruta PUT para actualizar registro en la tabla espacios.
router.put('/espacios', (req, res) => {
