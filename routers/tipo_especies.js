...
const routertipo_especies = express.Router();

// Importamos la conexión a la base de datos 
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de las especies.
routertipo_especies.get('/tipo_especies', (req, res) => {
    ...
    const columnas = 'cod_tipo_especie, nombre_especie';

    // Definimos el nombre de la tabla.
    const tabla = 'tipo_especies';
...
// Ruta POST para insertar un nuevo tipo_especie.
routertipo_especies.post('/tipo_especies', (req, res) => {
    ...
    // Armamos los valores, con cod_tipo_especie sin comillas (porque es número)
    const datos = `${cod_tipo_especie}, '${nombre_especie}'`;
...
// Definimos la ruta PUT para actualizar registro en la tabla tipo_especie.
routertipo_especies.put('/tipo_especies', (req, res) => {
...
module.exports = routertipo_especies;