...
router.get('/correos', (req, res) => {
    ...
    const columnas = 'cod_correos, direccion_correo, fecha_registro, estado_correo';
...
router.post('/correos', (req, res) => {
    ...
    const datos = `${cod_correos}, '${direccion_correo}', '${fecha_registro}', ${estado_correo}`;
