...
// Definimos una ruta GET para obtener todos los registros de los usuarios.
router.get('/usuarios', (req, res) => {
    ...
    const columnas = 'cod_usuario, cod_permiso, nombre_usuario, contrasena, estado_usuario, primer_acceso, cod_bitacora';
...
//------------------------------------------------------------------------------------
// Ruta POST para insertar una nuevo usuario.
router.post('/usuarios', (req, res) => {
    ...
    const datos = `${cod_usuario}, ${cod_permiso}, '${nombre_usuario}', '${contrasena}', '${estado_usuario}', ${primer_acceso}, ${cod_bitacora}`;
