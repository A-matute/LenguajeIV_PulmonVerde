...
// Definimos una ruta GET para obtener todos los registros de la tabla usuarios_roles.
router.get('/usuarios_roles', (req, res) => {
    ...
    const columnas = 'cod_usuario, cod_rol';


    // Definimos el nombre de la tabla.
    const tabla = 'usuarios_roles';
...
// Ruta POST para insertar una nuevo registro de usuario_roles
router.post('/usuarios_roles', (req, res) => {
    ...
    // Armamos los valores, con cod_usuario sin comillas (porque es número)
    const datos = `${cod_usuario}, ${cod_rol}`;
...
router.put('/usuarios_roles', (req, res) => {
