...
router.get('/cabanas', (req, res) => {
    ...
    const columnas = 'cod_cabana, tipo_cabana, ubicacion, cant_personas, precio, cod_espacio';
...
router.post('/cabanas', (req, res) => {
    ...
    const datos = `${cod_cabana}, '${tipo_cabana}', '${ubicacion}', '${cant_personas}', '${precio}', '${cod_espacio}'`;
