...
const routertipo_alertas = express.Router();

// Importamos la conexión a la base de datos 
const db = require('../config/db-connection');

// Definimos una ruta GET para obtener todos los registros de las alertas.
routertipo_alertas.get('/tipo_alertas', (req, res) => {
    ...
    const columnas = 'cod_tipo_alerta, nombre_alerta';

    // Definimos el nombre de la tabla.
    const tabla = 'tipo_alertas';
...
// Ruta POST para insertar un nuevo tipo_alerta.
routertipo_alertas.post('/tipo_alertas', (req, res) => {
    ...
    // Armamos los valores, con cod_tipo_alerta sin comillas (porque es número)
    const datos = `${cod_tipo_alerta}, '${nombre_alerta}'`;
...
// Definimos la ruta PUT para actualizar registro en la tabla tipo_alertas.
routertipo_alertas.put('/tipo_alertas', (req, res) => {
...
module.exports = routertipo_alertas;