...
// Importamos la conexión a la base de datos (desde models/eventos_ambientales-model.js)
...
router.get('/eventos_ambientales', (req, res) => {
    ...
    const columnas = 'cod_evento, fecha_hora_evento, Descripcion, cod_tipo_evento, cod_parque, cod_especie';
...
router.post('/eventos_ambientales', (req, res) => {
   ...
   // Armamos los valores, con cod_evento sin comillas (porque es número)
    const datos = `${cod_evento}, '${fecha_hora_evento}', '${Descripcion}', ${cod_tipo_evento}, ${cod_parque}, ${cod_especie}`;
